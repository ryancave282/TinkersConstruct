...
import net.ryancave282.tconstruct.common.registration.BlockDeferredRegisterExtension;
import net.ryancave282.tconstruct.common.registration.EnumDeferredRegister;
import net.ryancave282.tconstruct.common.registration.ItemDeferredRegisterExtension;
...
public abstract class TinkerModule {
  ...
  protected static final SynchronizedDeferredRegister<ParticleType<?>> PARTICLE_TYPES = SynchronizedDeferredRegister.create(NeoForgeRegistries.PARTICLE_TYPES, TConstruct.MOD_ID);
  ...
  // datapacks
  protected static final SynchronizedDeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = SynchronizedDeferredRegister.create(NeoForgeRegistries.RECIPE_SERIALIZERS, TConstruct.MOD_ID);
  protected static final SynchronizedDeferredRegister<Codec<? extends IGlobalLootModifier>> GLOBAL_LOOT_MODIFIERS = SynchronizedDeferredRegister.create(NeoForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, TConstruct.MOD_ID);
