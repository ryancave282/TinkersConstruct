...
public class ClientInteractionHandler {
  ...
  /** Implements the client side of chestplate {@link GeneralInteractionModifierHook#onToolUse(IToolStackView, ModifierEntry, Player, InteractionHand, InteractionSource)} */
  ...
  /** Implements the client side of left click interaction for {@link GeneralInteractionModifierHook#onToolUse(IToolStackView, ModifierEntry, Player, InteractionHand, InteractionSource)} */
  @SubscribeEvent
