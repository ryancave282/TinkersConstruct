...
import net.ryancave282.tconstruct.library.recipe.melting.MeltingRecipeLookup;
 ...
 * Note the former is possible with {@link IsEffectiveModule} using {@link TinkerPredicate#CAN_MELT_BLOCK}, but the latter requires tool context.
 */
