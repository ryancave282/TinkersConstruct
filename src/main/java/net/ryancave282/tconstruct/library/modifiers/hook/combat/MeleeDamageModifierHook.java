package net.ryancave282.tconstruct.library.modifiers.hook.combat;
...
public interface MeleeDamageModifierHook {
   ...
   * Alternatives:
   * <ul>
   *   <li>{@link ToolStatsModifierHook}: Adjusts the base tool stats that show in the tooltip, but has less context for modification</li>
