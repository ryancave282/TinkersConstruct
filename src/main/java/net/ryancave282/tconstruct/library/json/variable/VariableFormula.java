...
import net.ryancave282.tconstruct.library.json.math.StackOperation;

import java.util.LinkedHashMap;
import java.util.List;
import java.util.Map;

import static net.ryancave282.tconstruct.library.json.math.ModifierFormula.BASE_VALUE;
