...
import net.ryancave282.tconstruct.library.recipe.modifiers.adding.AbstractModifierRecipe;
...
public interface ITinkerStationRecipe extends ICommonRecipe<ITinkerStationContainer> {
   ...
   * In most cases, it's better to use {@link AbstractModifierRecipe}{@code #success()} as it responds to your specific {@link #shrinkToolSlotBy()}.
   */
